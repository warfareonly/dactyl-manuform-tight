...
(def lastrowminusone 2)
(def actuallastrowminusone 3)
(def cornerrow (dec lastrow))
(def cornerrowminusone (dec cornerrow))
  ...
  (apply union
         (for [column columns
               ...
               :when ;(or (.contains [2 3] column);
                         (not= row lastrow)] ; got rid of a ) here
           (->> shape
  ...
  (apply union
         (concat
           ...
           (for [column (range 0 (dec ncols))
                 row (range 0 actuallastrowminusone)]
             (triangle-hulls
...
(def thumb-connectors
  (union
   ...
   ;   (key-place 2 actuallastrowminusone web-post-br)
   ;   (key-place 3 actuallastrowminusone web-post-bl)
   ;   (key-place 2 actuallastrowminusone web-post-tr)
   ;   (key-place 3 actuallastrowminusone web-post-tl)
   ;   (key-place 3 cornerrow web-post-bl)
   ;   (key-place 3 actuallastrowminusone web-post-tr)
   ;   (key-place 3 cornerrow web-post-br)
   ;   (key-place 4 cornerrow web-post-bl))
    (triangle-hulls
      (key-place 1 cornerrow web-post-br)
      (key-place 2 actuallastrowminusone web-post-tl)
    ...
    (piramid-hulls                                          ; top ridge thumb side
      ...
      ;this is supposed to be commented out(thumb-r-place web-post-tr)
      (thumb-r-place web-post-tl)
      (thumb-m-place web-post-tr)
      (key-place 0 cornerrow (translate (wall-locate3 -1 0) web-post-bl))
      )
    (debug (triangle-hulls
...
(def case-walls
  (union
    ...
    ; front wall
    (key-wall-brace 3 lastrowminusone 0 -1 web-post-bl 3 lastrowminusone 0.5 -1 web-post-br)
    (key-wall-brace 3 lastrowminusone 0.5 -1 web-post-br 4 cornerrow 0.5 -1 web-post-bl)
    ...
    (wall-brace thumb-r-place 0 -1 web-post-br (partial key-place 3 lastrowminusone) 0 -1 web-post-bl)
    ; thumb walls
    ...
    (wall-brace thumb-m-place -1 0 web-post-tl thumb-m-place -1 0 web-post-bl)
    ; thumb corners
    ...
    (wall-brace thumb-m-place -1 0 web-post-bl thumb-m-place 0 -1 web-post-bl)
    (wall-brace thumb-m-place -1 0 web-post-tl thumb-m-place 0 1 web-post-tl)
    ; thumb tweeners
